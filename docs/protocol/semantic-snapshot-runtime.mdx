...
> **Authority:** Normative summary · **Status:** Implemented candidate; public edge staged · **Applies to:** E3.3 snapshot profile · **Verified against:** snapshot `sha256:54739822257ef617b136454285a8fd47802f0960c7cf53a49abd2d5d1f1389c5` · **Source:** `spec/data-plane/READ_ONLY_SNAPSHOT_RUNTIME_0_1.md`, `internal/snapshotruntime`
...
The staged Meridian service runs as a dedicated unprivileged user on literal
...
The service is installed and passes loopback and target-host isolation checks.
It is not yet a public execution claim: `lab.twirx.org` DNS, TLS and wire
verification must pass before the edge is activated.
