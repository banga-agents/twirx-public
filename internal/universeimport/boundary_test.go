...
func TestImporterProductionBoundaryHasNoNetworkProcessOrUnsafeImports(t *testing.T) {
	assertForbiddenImportsAbsent(t, ".")
}

func assertForbiddenImportsAbsent(t *testing.T, directory string) {
	t.Helper()
